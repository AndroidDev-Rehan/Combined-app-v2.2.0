...
class StateCart extends State<Cart> with TickerProviderStateMixin {
  ...
  ScrollController _scrollControllerOnCartItems = new ScrollController();
  ScrollController _scrollControllerOnSaveForLaterItems =
          ...
          children: [
            Card(
              ...
              child: Row(
                children: <Widget>[
                  Hero(
                      tag: "CListItem$index${cartList[index].productList![0].id}",
                      child: Stack(
                        children: [
                          ClipRRect(
                              ...
                              child: Stack(children: [
                                FadeInImage(
                                  image: CachedNetworkImageProvider(cartList[index].productList![0].image!,),
                                  height: 100.0,
                                  width: 100.0,
                                  fit: extendImg
                                      ? BoxFit.fill
        ...
        child: Column(
          children: [
            Row(
              children: <Widget>[
                Hero(
                    tag: "CartItem$index${cartList[index].productList![0].id}",
                    child: ClipRRect(
                        borderRadius: BorderRadius.circular(7.0),
                        child: FadeInImage(
        ...
        Card(
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                Hero(
                    tag: "SaveIn$index${saveLaterList[index].productList![0].id}",
                    child: Stack(
                      children: [
                        ClipRRect(
                            borderRadius: BorderRadius.circular(7.0),
    ...
    try {
      ...
      if (!error) {
        ...
        var paytmResponse = Paytm.payWithPaytm(callBackUrl:callBackUrl ,mId: paytmMerId!,orderId:  orderId, txnToken: txnToken,
            txnAmount: totalPrice.toString(),staging:  payTesting);
