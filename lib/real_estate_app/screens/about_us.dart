...
import '../components/aboutus_componetns.dart';
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Center(child: Text('C',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 9),)),
                  ),  Text(' 2020 Real Estate',style: TextStyle(fontWeight: FontWeight.bold),),
                ],
              ),
              SizedBox(height: 10,),
              Text('www.realestate.net',style: TextStyle(fontWeight: FontWeight.w500),)
             ,SizedBox(height: 20,)
            ],
          ),
        ),
