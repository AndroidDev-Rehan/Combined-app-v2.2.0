                  ...
                  Row(
                    ...
                    children: [
                      socialMediaButton(
                          ...
                          callback: () {},
                          text: 'Google',color: Colors.grey[200]!),
                      socialMediaButton(
                          img: 'assets/icons/fb.png',
                          callback: () {},
                          text: 'Facebook',color: Colors.grey[200]!),
                    ],
                  ),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                          ...
                          ,child: Text('Sign In',style: TextStyle(color: primaryColor,fontWeight: FontWeight.bold,decoration: TextDecoration.underline),))
                    ],
                  )
                ],
              ),
